...
# ── VPC ──────────────────────────────────────────────────────────────
module "vpc" {
  source = "git::https://github.com/YoungMinds2024/terraform-module-vpc.git"
...
module "subnets" {
  source = "git::https://github.com/YoungMinds2024/terraform-module-subnet.git"
...
module "ec2_instances" {
  source = "git::https://github.com/YoungMinds2024/terraform-module-ec2.git"
